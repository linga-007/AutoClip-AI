# AutooClip AI — Chrome Extension

AutooClip AI lets you right‑click any selected text in Chrome and send it straight to a Notion page or database.
...
1. In Chrome, right‑click the AutooClip AI icon in the toolbar and choose **Options**  
...
4. If Notion is not configured, AutooClip AI falls back to saving a local markdown file and copying the text to your clipboard.
